...
# Recupérer les valeurs du tab 1 Pour faire une boucle sue eux afin de les comparer avec les valeurs du tab 2
for i in range(0, len(tab1)):
    # Recupérer les valeurs du tab 2 Pour faire une boucle sue eux afin de les comparer avec les valeurs du tab 1
...
# Ecrire
print('diviseurs du tableau 1: ', tab1, ' diviseurs du tableau 2: ',
